...
#         output_file.write("Yesterday Data:\t\tToday's Data:\n\n")
...
#             if len(fields1) == 12 and len(fields2) == 12:
#                 country = fields1[0]
...
#                 output_file.write(f"Active Cases: {active_cases1}\t\tActive Cases: {active_cases2}\n")
                
#                 if daily_deaths2 == fields1[9]:
#                     output_file.write(f"Daily Deaths: {daily_deaths1}\t\tDaily Deaths: {daily_deaths2}\n")
#                 else:
#                     output_file.write(f"Daily Deaths: {daily_deaths1}\t\tDaily Deaths: +{daily_deaths2[1:]}\n")
                
#                 if new_recovered2 == fields1[11]:
#                     output_file.write(f"New Recovered: {new_recovered1}\t\tNew Recovered: {new_recovered2}\n")
#                 else:
#                     output_file.write(f"New Recovered: {new_recovered1}\t\tNew Recovered: +{new_recovered2[1:]}\n")
                
#                 if new_cases2 == fields1[10]:
#                     output_file.write(f"New Cases: {new_cases1}\t\tNew Cases: {new_cases2}\n\n")
#                 else:
#                     output_file.write(f"New Cases: {new_cases1}\t\tNew Cases: +{new_cases2[1:]}\n\n")
...
def main():
    ...
    print("Data Extracted Successfully(Todays's Table is saved in main2.txt)")
