...
_lr_productions = [
  ...
  ('start -> st','start',1,'p_start','module1.py',118),
  ('skipcontent -> CONTENT skipcontent','skipcontent',2,'p_skipcontent','module1.py',123),
  ('skipcontent -> <empty>','skipcontent',0,'p_skipcontent','module1.py',124),
  ('handledata -> OPENDATA CLOSEDATA skipcontent','handledata',3,'p_handledata','module1.py',128),
  ('handledata -> OPENDATA CONTENT CLOSEDATA skipcontent','handledata',4,'p_handledata','module1.py',129),
  ('handledata -> OPENDATA CONTENT CONTENT CLOSEDATA skipcontent','handledata',5,'p_handledata','module1.py',130),
  ('handledata -> OPENDATA OPENHREF CONTENT CLOSEHREF CLOSEDATA skipcontent','handledata',6,'p_handledata','module1.py',131),
  ('handledata -> OPENDATA OPENHREF CONTENT CONTENT CLOSEHREF CLOSEDATA skipcontent','handledata',7,'p_handledata','module1.py',132),
  ('skipheaders -> OPENHEADER CONTENT CLOSEHEADER skipheaders','skipheaders',4,'p_skipheaders','module1.py',170),
  ('skipheaders -> OPENHEADER CONTENT CONTENT CLOSEHEADER skipheaders','skipheaders',5,'p_skipheaders','module1.py',171),
  ('skipheaders -> <empty>','skipheaders',0,'p_skipheaders','module1.py',172),
  ('printhandledata -> handledata printhandledata','printhandledata',2,'p_printhandledata','module1.py',177),
  ('printhandledata -> <empty>','printhandledata',0,'p_printhandledata','module1.py',178),
  ('handlerow -> OPENROW printhandledata CLOSEROW skipcontent handlerow','handlerow',5,'p_handlerow','module1.py',182),
  ('handlerow -> <empty>','handlerow',0,'p_handlerow','module1.py',183),
  ('st -> BEGINTABLE OPENHEAD OPENROW skipheaders CLOSEROW CLOSEHEAD OPENBODY handlerow CLOSEBODY','st',9,'p_st','module1.py',187),
  ('st -> <empty>','st',0,'p_st','module1.py',188),
]
